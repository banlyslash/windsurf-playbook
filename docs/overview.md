...
- **Model Context Protocol (MCP) Community**: For standardizing AI-tool integration
...
- Project initialization workflows and conventions
- Framework-specific rules and guidelines (Spring Boot, React, etc.)
...
- **[GenAI Practitioner Guide](https://genai.practitioner.help/)** - A comprehensive resource that inspired the structure and approach of this playbook
- Industry best practices in software development
- Academic research in human-AI collaboration
...
- **Repository**: [slashdigital/windsurf-playbook](https://github.com/slashdigital/windsurf-playbook)
- **License**: MIT License
- **Primary Language**: TypeScript (Docusaurus-based)
- **Active Contributors**: 3+ core contributors
...
- **Quiz Randomization** (PR #5, #6) - Fisher-Yates algorithm implementation with 36+ questions covering Web Search, Prompt Engineering, Project Workflows, and Integration Scenarios
- **SEO Implementation** (PR #1) - Comprehensive SEO with structured data, Open Graph, Twitter Cards, and sitemap generation
...
- Suggesting new topics or sections
- Sharing your workflows and patterns
...
```
Windsurf Playbook by Banly Tong and Contributors
...
>
> Every pattern, workflow, and best practice documented here comes from real experience—the successes, the failures, and the lessons learned along the way. I hope this playbook helps you navigate your own journey with confidence and curiosity.
>
...
Thank you for being part of the Windsurf community. Together, we're shaping the future of software development.
